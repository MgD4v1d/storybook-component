...
export declare const CustomBagroundColor: ComponentStory<({ allCaps, color, label, size, fontColor, backgroundColor }: import("../../components/MyLabel").MyLabelProps) => JSX.Element>;
